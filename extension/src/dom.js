export const elements = {
  ...
  emptyCreateBtnEl: document.getElementById("emptyCreateNote"),
  ...
  emptyOpenDocsEl: document.getElementById("emptyOpenDocs"),
